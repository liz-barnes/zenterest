  ...
  $('#nav').html(
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
        ...
        <li class="nav-item">
          <a id="board-form" class="nav-link" href="#">Add Board<span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item ">
          <a id="pin-form" class="nav-link" href="#">Add Pin<span class="sr-only">(current)</span></a>
        </li>
      </ul>
